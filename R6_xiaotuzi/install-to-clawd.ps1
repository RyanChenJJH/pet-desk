...
# 将小兔子桌面宠物主题一键安装到 Clawd-on-desk 用户主题目录

$targetDir = "$env:APPDATA\clawd-on-desk\themes\xiaotuzi"

Write-Host "=========================================" -ForegroundColor Cyan
Write-Host " Installing Xiaotuzi Theme to Clawd-on-Desk" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
...
Write-Host "`n✓ 成功安装/同步小兔子主题至:" -ForegroundColor Green
...
Write-Host "3. 在主题下拉列表中选择 'Xiaotuzi' 即可与小兔子一同工作！`n"
