...
# 将大水牛桌面宠物主题一键安装到 Clawd-on-desk 用户主题目录

$targetDir = "$env:APPDATA\clawd-on-desk\themes\dashuiniu"

Write-Host "=========================================" -ForegroundColor Cyan
Write-Host " Installing Dashuiniu Theme to Clawd-on-Desk" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
...
Write-Host "`n✓ 成功安装/同步大水牛主题至:" -ForegroundColor Green
...
Write-Host "3. 在主题下拉列表中选择 'Dashuiniu' 即可与大水牛一同敲代码！`n"
